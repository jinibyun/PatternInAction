...
namespace Transactions
{
    ...
    /// 
    /// Just as a practical matter: if your application uses a single database, 
    /// say, SQL Server, then there is no need to decorate the Transaction Scope.
    /// </summary>
    /// <remarks>
    ...
    {
        private static readonly string _OleDb = "System.Data.OleDb";
