...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br />
     ...
     <asp:GridView ID="GridViewCart" SkinID="CartSkin"
        ...
        <Columns>
		  ...
		  <asp:HyperLinkField HeaderText="&nbsp;Description" DataNavigateUrlFields="Id" DataNavigateUrlFormatString="~/shop/products/{0}" 
          ...
          <asp:TemplateField>
            ...
            <ItemStyle HorizontalAlign="Right"></ItemStyle>
            <ItemTemplate>
              <asp:ImageButton Runat="server" ID="ImageButtonRemove" ImageUrl="~/assets/images/app/Remove.jpg" CommandName="Delete" CommandArgument='<%# Eval("Id") %>'></asp:ImageButton>
            </ItemTemplate>
          </asp:TemplateField>
    ...
    <table border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="70"><asp:Image ID="ImageSpacer1" runat="server" ImageUrl="~/assets/images/app/spacer.gif" Width="70" height="1" BorderWidth="0" /></td>
      </tr>
      <tr>
        ...
        <td ><asp:Image ID="ImageSpacer2" runat="server" ImageUrl="~/assets/images/app/spacer.gif" Width="70" height="1" BorderWidth="0" /></td>
      </tr>
      ...
      <tr>
        ...
        <td width="70"><asp:Image ID="ImageSpacer3" runat="server" ImageUrl="~/assets/images/app/spacer.gif" Width="70" height="1" BorderWidth="0" /></td>
      </tr>
      <tr>
        <td height="36" colspan="3" align="left" valign="middle"><asp:HyperLink ID="HyperLinkCheckoutBottom" runat="Server" 
         CssClass="cartlink" Text="Checkout" NavigateUrl="~/shop/checkout" /></td>
      </tr>
     </table>
    </ContentTemplate>
   </asp:UpdatePanel>
