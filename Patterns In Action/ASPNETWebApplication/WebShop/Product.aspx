...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:DetailsView ID="DetailViewProduct" runat="server" 
         ...
         <Fields>
          <asp:TemplateField HeaderText="Category&nbsp;" ItemStyle-BackColor="#ffeecc" ItemStyle-Font-Bold="True" >
            <ItemTemplate>
    ...
    <asp:ObjectDataSource ID="ObjectDataSourceProduct" runat="server" 
        TypeName="ASPNETWebApplication.Repositories.ProductRepository" SelectMethod="GetProduct">
       <SelectParameters>
